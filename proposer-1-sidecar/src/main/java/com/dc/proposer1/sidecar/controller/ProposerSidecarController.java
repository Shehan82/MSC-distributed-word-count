package com.dc.proposer1.sidecar.controller;

import com.dc.proposer1.sidecar.dto.LineDTO;
import com.dc.proposer1.sidecar.dto.ProposerRequestDTO;
import com.dc.proposer1.sidecar.exception.CallNotPermittedRabbitMQException;
import com.dc.proposer1.sidecar.service.ProposerSidecarService;
...
public class ProposerSidecarController {
    ...
    @RabbitListener(queues = "proposer-queue-8094", ackMode = "MANUAL")
